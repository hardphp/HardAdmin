...
<script setup lang="ts" name="cgcolumnLists">
import { defineAsyncComponent, reactive, ref, onMounted } from 'vue';
import { ElMessage } from 'element-plus';
import { getList,getListAll,del,change } from '/@/api/cgcolumn/index';
...
const EditDialog = defineAsyncComponent(() => import('/@/views/cogen/cgcolumn/form/edit.vue'));
...
const state = reactive<TableDemoState>({
	tableData: {
        ...
        { key: 'name', colWidth: '', title: '栏目名称', type: 'text', isCheck: true },
        ...
        isAdd: 'admin:cogencgcolumn:save', //新增标识
        isUpdate: 'admin:cogencgcolumn:save', //修改标识
        isDelete: 'admin:cogencgcolumn:del', //删除标识 
    },
		// 搜索表单，动态生成（传空数组时，将不显示搜索，注意格式）
		search: [
        { label: '栏目名称', prop: 'name', placeholder: '请输入栏目名称', required: false, type: 'input' },
    ],
