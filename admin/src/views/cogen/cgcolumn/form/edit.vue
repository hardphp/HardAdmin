				 ...
				 <el-row :gutter="35">
                    <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="上级id" prop="pid">
							<el-select v-model="state.ruleForm.pid" placeholder="请选择" clearable class="mb20">
...
<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
                    ...
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="英文名称" prop="ename">
							<el-input v-model="state.ruleForm.ename" placeholder="请输入英文名称" clearable></el-input>
						</el-form-item>
					</el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="seo关键词" prop="seo_title">
							<el-input v-model="state.ruleForm.seo_title" placeholder="请输入seo关键词" clearable></el-input>
						</el-form-item>
					</el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="网址" prop="url">
							<el-input v-model="state.ruleForm.url" placeholder="请输入网址" clearable></el-input>
						</el-form-item>
					</el-col>
                    <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                    ...
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="banner图" prop="imgs">
							<Uploadimg  v-model="state.ruleForm.imgs" :value="state.ruleForm.imgs"  @upload="onUpload" :msg="state.msg"/>
						</el-form-item>
					</el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="banner图" prop="imgs2">
							<Uploadimg  v-model="state.ruleForm.imgs2" :value="state.ruleForm.imgs2"  @upload="onUpload" :msg="state.msg"/>
						</el-form-item>
					</el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="图标" prop="icon">
							<Uploadimg  v-model="state.ruleForm.icon" :value="state.ruleForm.icon"  @upload="onUpload" :msg="state.msg"/>
						</el-form-item>
					</el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="seo描述" prop="seo_dec">
							<el-input v-model="state.ruleForm.seo_dec" placeholder="请输入seo描述" type="textarea" :rows="2" clearable></el-input>
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup lang="ts" name="cgcolumnForm">
import { reactive, defineAsyncComponent,onMounted, ref ,unref,nextTick} from 'vue';
import { getinfo,save } from '/@/api/cgcolumn/index';
...
const openDialog = (type: string, row?: any) => {
	if (type === 'edit') {
      ...
      state.ruleForm.ename = response.data.ename;
      state.ruleForm.seo_title = response.data.seo_title;
      ...
      state.ruleForm.imgs = response.data.imgs;
      state.ruleForm.imgs2 = response.data.imgs2;
      state.ruleForm.url = response.data.url;
      state.ruleForm.types = response.data.types;
      state.ruleForm.pid = response.data.pid;
