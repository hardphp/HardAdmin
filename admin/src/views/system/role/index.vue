...
import { getList,del,change } from '/@/api/group/index';

// 引入组件
const Table = defineAsyncComponent(() => import('/@/components/table/index.vue'));
const TableSearch = defineAsyncComponent(() => import('/@/components/table/search.vue'));
const EditDialog = defineAsyncComponent(() => import('/@/views/system/role/form/edit.vue'));
...
const state = reactive<TableDemoState>({
	tableData: {
		...
		header: [
			...
			{ key: 'status', colWidth: '100', title: '状态', type: 'radio', dict:{'1':'正常','0':'禁用'},isCheck: true },
		...
		config: {
			...
			isAdd: 'admin:groups:save', //新增标识
			isUpdate: 'admin:groups:save', //修改标识
			isDelete: 'admin:groups:del', //删除标识
