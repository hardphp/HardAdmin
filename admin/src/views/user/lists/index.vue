...
const state = reactive<TableDemoState>({
	tableData: {
		...
		header: [
			...
			{ key: 'is_enabled', colWidth: '', title: '状态', type: 'radio', dict:{'1':'正常','0':'禁用','2':'待审核'},isCheck: true },
			{ key: 'login_time', colWidth: '200', title: '登录', type: 'datetime', isCheck: true },
		...
		config: {
			...
			isAdd: 'admin:user:save', //新增标识
			isUpdate: 'admin:user:save', //修改标识
			isDelete: 'admin:user:del', //删除标识

		},
		// 搜索表单，动态生成（传空数组时，将不显示搜索，注意格式）
		search: [
			{ label: '姓名', prop: 'realname', placeholder: '请输入姓名', required: false, type: 'input' },
